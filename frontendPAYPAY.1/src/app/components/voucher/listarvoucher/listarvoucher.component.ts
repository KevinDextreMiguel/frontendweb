...
@Component({
  ...
  standalone: true,
  imports: [MatTableModule,CommonModule,MatButtonModule,MatFormFieldModule,RouterLink,MatPaginatorModule,MatInputModule,MatIconModule,EliminarvoucherComponent],
